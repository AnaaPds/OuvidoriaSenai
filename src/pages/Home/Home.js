...
function Home() {
  ...
  return React.createElement('div', { className: 'home-container' }, [
    ...
    React.createElement('div', { className: 'banner-container', key: 'banner-container' }, [
      ...
      React.createElement('div', { className: 'texto-bemvindo' }, [
        React.createElement('h1', {}, 'OUVIDORIA'),
        React.createElement('h2', {}, 'Bem-vindo à Ouvidoria do SENAI Suíço Brasileira')
      ])
    ]),

    React.createElement('div', { className: 'drop-area', key: 'drops' }, [
      React.createElement(Dropdown, { titulo: 'O que é?' }, 'A Ouvidoria é um canal de comunicação entre a comunidade e a escola, onde é possível enviar denúncias, reclamações, sugestões e elogios. Ela busca garantir um atendimento transparente e imparcial.'),
      React.createElement(Dropdown, { titulo: 'Quem pode utilizar este serviço?' }, 'Alunos, pais, colaboradores e todos os membros da comunidade escolar podem acessar a Ouvidoria para expressar suas preocupações, sugestões e reconhecimentos.'),
      React.createElement(Dropdown, { titulo: 'Etapas para utilização deste serviço' }, '1- Escolha o tipo de manifestação (denúncia, reclamação, elogio ou sugestão). 2- Preencha o formulário com as informações solicitadas. 3- Envie a manifestação e aguarde o retorno da Ouvidoria. 4- Acompanhe o status da sua manifestação, se disponível.'),
      React.createElement(Dropdown, { titulo: 'Perguntas Frequentes sobre a Ouvidoria' }, 'Veja o FAQ no rodapé.'),
      React.createElement(Dropdown, { titulo: 'Outras informações' }, 'Entre em contato conosco.')
    ]),
